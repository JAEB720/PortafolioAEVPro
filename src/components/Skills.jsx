        ...
        >
            ...
            <Card  style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }} >
              <Card.Content textAlign='center' > 
                <Card.Description  ><Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
                  <Image  src="/skills/html.png" alt="Logo 1" style={{ maxWidth: '15%', maxHeight: '10%',}} />
                  HTML</Button>
                </Card.Description>
              </Card.Content>
            </Card>
          ...
          <div>
            <Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
              <Card.Content>
                <Card.Description> <Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
                  <Image src="/skills/css.png" alt="Logo 2" style={{ maxWidth: '15%', maxHeight: '10%',}} />
                 CSS</Button>
                </Card.Description>
              </Card.Content>
            </Card>
          ...
          <div>
            <Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
              <Card.Content>
                <Card.Description> <Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
                  <Image src="/skills/react.png" alt="Logo 4" style={{ maxWidth: '15%', maxHeight: '10%',}} />
                 React</Button>
                </Card.Description>
              </Card.Content>
            </Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }} >
  <Card.Content > 
    <Card.Description  >  <Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image  src="/skills/node.png" alt="Logo 1" style={{ maxWidth: '15%', maxHeight: '10%',  }}/>
    Node</Button>
    </Card.Description>
  </Card.Content>
</Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
  <Card.Content>
    <Card.Description><Button style={{background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image src="/skills/express.png" alt="Logo 2" style={{ maxWidth: '15%', maxHeight: '15%', }}/>
      Express</Button>
    </Card.Description>
  </Card.Content>
</Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }} >
  <Card.Content > 
    <Card.Description   > <Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image  src="/skills/js.png" alt="Logo 1" style={{ maxWidth: '15%', maxHeight: '10%',  }} />
     JavaScript</Button>
    </Card.Description>
  </Card.Content>
</Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
  <Card.Content>
    <Card.Description>  <Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image src="/skills/python.png" alt="Logo 2" style={{ maxWidth: '15%', maxHeight: '10%', }}/>
    Python</Button>
    </Card.Description>
  </Card.Content>
</Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
  <Card.Content > 
    <Card.Description  ><Button fluid style={{background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image  src="/skills/semantic.png" alt="Logo 1" style={{ maxWidth: '15%', maxHeight: '10%', }} />
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
  <Card.Content>
    <Card.Description><Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image src="/skills/opencv.png" alt="Logo 2" style={{ maxWidth: '15%', maxHeight: '10%',}} />
      OpenCV</Button>
    </Card.Description>
  </Card.Content>
</Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
  <Card.Content>
    <Card.Description> <Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image src="/skills/three.png" alt="Logo 3" style={{ maxWidth: '13%', maxHeight: '10%', }} />
     Three</Button>
    </Card.Description>
  </Card.Content>
</Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
  <Card.Content>
    <Card.Description> <Button fluid style={{background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))',display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image src="/skills/tailwind.png" alt="Logo 3" style={{ maxWidth: '15%', maxHeight: '10%',margin:"0.3rem"}} />
     Tailwind</Button>
    </Card.Description>
  </Card.Content>
</Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
  <Card.Content>
    <Card.Description> <Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))',display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image src="/skills/npm.png" alt="Logo 3" style={{ maxWidth: '20%', maxHeight: '10%', margin:"0.3rem"}} />
     NPM</Button>
    </Card.Description>
  </Card.Content>
</Card>
...
<Card style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', }}>
  <Card.Content>
    <Card.Description> <Button fluid style={{ background: 'linear-gradient(rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.9))', display:"flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', color:"white" }}>
      <Image src="/skills/git.png" alt="Logo 4" style={{ maxWidth: '14%', maxHeight: '10%',margin:"0.2rem" }} />
     Git</Button>
    </Card.Description>
  </Card.Content>
</Card>
